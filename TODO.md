...
- [ ] **Review Module Naming:**
  - In some cases, a Ruby module is named `CPPN` and in others `Cppn`. We should be consistend and always use the same form.
  Review all code to determine if all modules are name consistently. Fix all inconsistencies.
